...
### 🟥 품질리스크형 : 생산성과 오류율이 높아 품질 리스크가 존재하는 작업자
* 재고의 신뢰도 저하 가능성 증가
...
💡Pareto 분석 결과,Pareto 분석 결과, 상위 5명의 작업자가 전체 오류의 약 73%를 차지하였고,
홍길동을 포함한 상위 6명 기준으로는 약 81%에 도달하였다.

이를 통해 우수 작업자의 작업 패턴을 기준화하고 오류 집중 작업자를 우선 관리하는 방식이 운영 효율 개선에 효과적일것으로 추측할 수 잇다.


따라서 김미자, 박영식, 유지한, 김정숙, 김철수를 우선 관리 대상으로 선정할 수 있다.
